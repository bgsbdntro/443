...
# Author  : BAGUS BUDIANTORO
# (C) Copyright 2021-2022 By BAGUS BUDIANTORO
# =========================================
...
echo -e "         OWNER : ${GREEN}ICNNETWORK ${NC}${YELLOW}(${NC} ${GREEN}BAGUS BUDIANTORO ${NC}${YELLOW})${NC}"
echo -e "       © Copyright By ICNNETWORK ${YELLOW}(${NC} 2021-2022 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
